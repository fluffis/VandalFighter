package gui;
/*
 RendererRowException class for CryptoDerk's Vandal Fighter
 ...
 * original author: Beren
 * http://cs.wikipedia.org/wiki/User:Beren
 */

public class RendererRowException extends RuntimeException {
  /**
   * 
   */
  private static final long serialVersionUID = 7051809804542344922L;

  public RendererRowException() {
    super();
  }
}
